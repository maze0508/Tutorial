...
<div id="page">
	...
	<div id="comment">
	<?php
		$query="SELECT member.name, group_anchor.group_anchor_id, group_anchor.anchor_descript, group_anchor.noteColor, group_anchor.anchor_time
				FROM member
				LEFT JOIN group_anchor ON member.member_id = group_anchor.member_id
				WHERE user_media_id =  '$user_media_id'
				AND group_anchor.member_id =  '$member_id'
...
$.post("php/group_delete_anchor.php",{group_anchor_id:group_anchor_id,button:"delete"},function(data) {
