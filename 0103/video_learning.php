	...
	<div id="content">
		<div class="post">
			...
			?>
				...
				?>	
				<div id='embed'>
				<center><object id="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" name="player" width="100%" height="350">
...
$.post("php/insert_anchor.php",{member_id:member_id,user_media_id:user_media_id,anchor_descript:$("#anchor_descript").val(),anchor_time:$("#anchor_time").text(),privacy:"privacy"},function(data) {
