...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php
	$group_image_id = mysql_escape_string($_GET['group_image_id']);
	$edit_note_class_id = mysql_escape_string($_GET['edit_note_class_id']);
	$query="SELECT group_image.image, group_image.anchor_time, group_image.user_media_id, group_image.noteColor
			FROM group_image
			WHERE group_image.group_image_id = '$group_image_id'
			";	
	...
	while($row = $result->fetch_array(MYSQL_ASSOC)){
		...
		echo"
		<div id='$group_image_id' class='article'>
	...
	?>
		...
		<script language="Javascript">
			var group_image_id = "<?php print $group_image_id; ?>";
			...
			$(function(){
				...
				$("#submit").click(function(){
					...
					if (parseInt(cw) > 0){
						...
						//alert(url_new);
						//alert(image_new);
						$.post("./php/group_crop_archive.php",{group_image_id:group_image_id,image_old:image_old,src:$src,x:cx,y:cy,w:cw,h:ch},
							function(data) {
								//alert(data);
