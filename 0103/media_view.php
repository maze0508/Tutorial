		...
		<div class="post">
			<div class="entry">
				...
				while($row = $result->fetch_array(MYSQL_ASSOC)){
				   ...
				   if($found)
						echo "<div class='temp_movie'><a href='media_player.php?user_media_id=$user_media_id'>$title<img src='' class='youtube' name='$url' /></a></div>";
				   else
						echo "<div class='temp_movie'><a href='media_player.php?user_media_id=$user_media_id'>$title<img src='user_pics/$url.jpg' /></a></div>";
